const _excluded = ["ns", "tagName", "className", "style", "children"],
  _excluded2 = ["$lang"];
...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('jszip')) : typeof define === 'function' && define.amd ? define(['exports', 'jszip'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.docx = {}, global.JSZip));
    ...
    if (isObject(target) && isObject(source)) {
      for (const key in source) {
        if (isObject(source[key])) {
          var _target$key;
          const val = (_target$key = target[key]) !== null && _target$key !== void 0 ? _target$key : target[key] = {};
  ...
  function convertLength(val) {
    let usage = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : LengthUsage.Dxa;
  ...
  function parseXmlString(xmlString) {
    let trimXmlDeclaration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  ...
  function hasXmlParserError(doc) {
    ...
    return (_doc$getElementsByTag = doc.getElementsByTagName("parsererror")[0]) === null || _doc$getElementsByTag === void 0 ? void 0 : _doc$getElementsByTag.textContent;
  }
  ...
  class XmlParser {
    elements(elem) {
      let localName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      const result = [];
    ...
    intAttr(node, attrName) {
      let defaultValue = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      var val = this.attr(node, attrName);
      return val ? parseInt(val) : defaultValue;
    }
    hexAttr(node, attrName) {
      let defaultValue = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      var val = this.attr(node, attrName);
      return val ? parseInt(val, 16) : defaultValue;
    }
    floatAttr(node, attrName) {
      let defaultValue = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      var val = this.attr(node, attrName);
      return val ? parseFloat(val) : defaultValue;
    }
    boolAttr(node, attrName) {
      let defaultValue = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      return convertBoolean(this.attr(node, attrName), defaultValue);
    }
    lengthAttr(node, attrName) {
      let usage = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : LengthUsage.Dxa;
  ...
  class OpenXmlPackage {
    ...
    get(path) {
      var _this$_zip$files$p;
      const p = normalizePath(path);
      return (_this$_zip$files$p = this._zip.files[p]) !== null && _this$_zip$files$p !== void 0 ? _this$_zip$files$p : this._zip.files[p.replace(/\//g, '\\')];
    }
    update(path, content) {
    ...
    save() {
      let type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "blob";
    ...
    load(path) {
      ...
      return (_this$get$async = (_this$get = this.get(path)) === null || _this$get === void 0 ? void 0 : _this$get.async(type)) !== null && _this$get$async !== void 0 ? _this$get$async : Promise.resolve(null);
    }
    async loadRelationships() {
      let path = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      let relsPath = `_rels/.rels`;
      if (path != null) {
        const _splitPath = splitPath(path),
          _splitPath2 = _slicedToArray(_splitPath, 2),
          f = _splitPath2[0],
          fn = _splitPath2[1];
  ...
  function parseSectionProperties(elem) {
    var _section$headerRefs, _section$footerRefs;
    let xml = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : globalXmlParser;
    var section = {};
    for (let e of xml.elements(elem)) {
      switch (e.localName) {
        case "pgSz":
        ...
        case "headerReference":
          ((_section$headerRefs = section.headerRefs) !== null && _section$headerRefs !== void 0 ? _section$headerRefs : section.headerRefs = []).push(parseFooterHeaderReference(e, xml));
          break;
        case "footerReference":
          ((_section$footerRefs = section.footerRefs) !== null && _section$footerRefs !== void 0 ? _section$footerRefs : section.footerRefs = []).push(parseFooterHeaderReference(e, xml));
          break;
        case "titlePg":
  ...
  class WordDocument {
    ...
    static async load(blob, parser, options) {
      ...
      await Promise.all(topLevelRels.map(rel => {
        var _d$rels$find;
        const r = (_d$rels$find = d.rels.find(x => x.type === rel.type)) !== null && _d$rels$find !== void 0 ? _d$rels$find : rel;
    ...
    async loadRelationshipPart(path, type) {
      ...
      await part.load();
      if (((_part$rels = part.rels) === null || _part$rels === void 0 ? void 0 : _part$rels.length) > 0) {
        const _splitPath3 = splitPath(part.path),
          _splitPath4 = _slicedToArray(_splitPath3, 1),
          folder = _splitPath4[0];
    ...
    async loadDocumentImage(id, part) {
      const path = this.getPathById(part !== null && part !== void 0 ? part : this.documentPart, id);
    ...
    findPartByRelId(id) {
      var _basePart$rels;
      let basePart = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var rel = ((_basePart$rels = basePart.rels) !== null && _basePart$rels !== void 0 ? _basePart$rels : this.rels).find(r => r.id == id);
      const folder = basePart ? splitPath(basePart.path)[0] : '';
      return rel ? this.partsMap[resolvePath(rel.target, folder)] : null;
    }
    getPathById(part, id) {
      const rel = part.rels.find(x => x.id == id);
      const _splitPath5 = splitPath(part.path),
        _splitPath6 = _slicedToArray(_splitPath5, 1),
        folder = _splitPath6[0];
    ...
    for (const at of globalXmlParser.attrs(elem)) {
      switch (at.localName) {
        ...
        case "fillcolor":
          ...
          break;
        case "from":
          const _parsePoint = parsePoint(at.value),
            _parsePoint2 = _slicedToArray(_parsePoint, 2),
            x1 = _parsePoint2[0],
            y1 = _parsePoint2[1];
          Object.assign(result.attrs, {
            x1,
          ...
          break;
        case "to":
          const _parsePoint3 = parsePoint(at.value),
            _parsePoint4 = _slicedToArray(_parsePoint3, 2),
            x2 = _parsePoint4[0],
            y2 = _parsePoint4[1];
          Object.assign(result.attrs, {
            x2,
  ...
  function parseStroke(el) {
    var _globalXmlParser$leng;
    return {
      'stroke': globalXmlParser.attr(el, "color"),
      'stroke-width': (_globalXmlParser$leng = globalXmlParser.lengthAttr(el, "weight", LengthUsage.Emu)) !== null && _globalXmlParser$leng !== void 0 ? _globalXmlParser$leng : '1px'
    };
  }
  ...
  class DocumentParser {
      ...
      for (const n of globalXmlParser.elements(node)) {
        switch (n.localName) {
          ...
          case "lvlPicBulletId":
            ...
            result.bullet = bullets.find(x => (x === null || x === void 0 ? void 0 : x.id) == bulletId);
            break;
          case "lvlText":
    ...
    parseChange(type, node, parentParser) {
      var _parentParser$childre, _parentParser;
      return {
        type,
        children: (_parentParser$childre = (_parentParser = parentParser(node)) === null || _parentParser === void 0 ? void 0 : _parentParser.children) !== null && _parentParser$childre !== void 0 ? _parentParser$childre : [],
    ...
    checkAlternateContent(elem) {
      ...
      return (_globalXmlParser$elem = globalXmlParser.element(elem, "Fallback")) === null || _globalXmlParser$elem === void 0 ? void 0 : _globalXmlParser$elem.firstElementChild;
    }
    parseDrawing(node) {
    ...
    parseDrawingWrapper(node) {
      ...
      for (var n of globalXmlParser.elements(node)) {
        switch (n.localName) {
          ...
          case "positionV":
            if (!simplePos) {
              var _globalXmlParser$attr;
              let pos = n.localName == "positionH" ? posX : posY;
              var alignNode = globalXmlParser.element(n, "align");
              var offsetNode = globalXmlParser.element(n, "posOffset");
              pos.relative = (_globalXmlParser$attr = globalXmlParser.attr(n, "relativeFrom")) !== null && _globalXmlParser$attr !== void 0 ? _globalXmlParser$attr : pos.relative;
    ...
    parseTableCellProperties(elem, cell) {
      cell.cssStyle = this.parseDefaultProperties(elem, {}, null, c => {
        var _globalXmlParser$attr2;
        switch (c.localName) {
          case "gridSpan":
            cell.span = globalXmlParser.intAttr(c, "val", null);
            break;
          case "vMerge":
            cell.verticalMerge = (_globalXmlParser$attr2 = globalXmlParser.attr(c, "val")) !== null && _globalXmlParser$attr2 !== void 0 ? _globalXmlParser$attr2 : "continue";
            break;
          case "cnfStyle":
    ...
    parseDefaultProperties(elem) {
      let style = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      let childStyle = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      let handler = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
      style = style || {};
      for (const c of globalXmlParser.elements(elem)) {
        if (handler !== null && handler !== void 0 && handler(c)) continue;
        switch (c.localName) {
          case "jc":
    ...
    parseSpacing(node, style) {
      ...
      if (before) style["margin-top"] = before;else if (beforeLines != null) style["margin-top"] = `${beforeLines / 100}em`;
      if (after) style["margin-bottom"] = after;else if (afterLines != null) style["margin-bottom"] = `${afterLines / 100}em`;
      if (line !== null) {
        switch (lineRule) {
          case "auto":
  ...
  class xmlUtil {
    static colorAttr(node, attrName) {
      let defValue = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      let autoColor = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'black';
  ...
  class values {
    ...
    static classNameOfCnfStyle(c) {
      ...
      const attrs = ['firstRow', 'lastRow', 'firstColumn', 'lastColumn', 'oddVBand', 'evenVBand', 'oddHBand', 'evenHBand', 'firstRowLastColumn', 'firstRowFirstColumn', 'lastRowLastColumn', 'lastRowFirstColumn'];
    ...
    static valueOfVertAlign(c) {
      let asTagName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      var type = globalXmlParser.attr(c, "val");
      switch (type) {
        case "subscript":
          return "sub";
  ...
  function updateTabStop(elem, tabs, defaultTabSize) {
    let pixelToPoint = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 72 / 96;
  ...
  function h(elem) {
    ...
    const ns = elem.ns,
      ...
      props = _objectWithoutProperties(elem, _excluded);
  ...
  class HtmlRenderer {
    ...
    async render(document, options) {
      ...
      this.h = (_options$h = options.h) !== null && _options$h !== void 0 ? _options$h : h;
      this.styleMap = null;
      this.tasks = [];
    ...
    renderTheme(themePart) {
      var _themePart$theme, _themePart$theme2;
      const variables = {};
      const fontScheme = (_themePart$theme = themePart.theme) === null || _themePart$theme === void 0 ? void 0 : _themePart$theme.fontScheme;
      if (fontScheme) {
    ...
    copyStyleProperties(input, output) {
    ...
    renderHeaderFooter(refs, props, page, firstOfSection, into) {
      ...
      if (part) {
        ...
        const _this$renderElements = this.renderElements([part.rootElement], into),
          _this$renderElements2 = _slicedToArray(_this$renderElements, 1),
          el = _this$renderElements2[0];
        if (props !== null && props !== void 0 && props.pageMargins) {
    ...
    isPageBreakSection(prev, next) {
      var _prev$pageSize, _next$pageSize, _prev$pageSize2, _next$pageSize2, _prev$pageSize3, _next$pageSize3;
      if (!prev) return false;
      if (!next) return false;
      return ((_prev$pageSize = prev.pageSize) === null || _prev$pageSize === void 0 ? void 0 : _prev$pageSize.orientation) != ((_next$pageSize = next.pageSize) === null || _next$pageSize === void 0 ? void 0 : _next$pageSize.orientation) || ((_prev$pageSize2 = prev.pageSize) === null || _prev$pageSize2 === void 0 ? void 0 : _prev$pageSize2.width) != ((_next$pageSize2 = next.pageSize) === null || _next$pageSize2 === void 0 ? void 0 : _next$pageSize2.width) || ((_prev$pageSize3 = prev.pageSize) === null || _prev$pageSize3 === void 0 ? void 0 : _prev$pageSize3.height) != ((_next$pageSize3 = next.pageSize) === null || _next$pageSize3 === void 0 ? void 0 : _next$pageSize3.height);
    }
    splitBySection(elements, defaultProps) {
        ...
        if (elem.type == DomType.Paragraph) {
          ...
          if (this.options.breakPages && p.children) {
            pBreakIndex = p.children.findIndex(r => {
              ...
              rBreakIndex = (_r$children$findIndex = (_r$children = r.children) === null || _r$children === void 0 ? void 0 : _r$children.findIndex(this.isPageBreakElement.bind(this))) !== null && _r$children$findIndex !== void 0 ? _r$children$findIndex : -1;
      ...
      for (let i = result.length - 1; i >= 0; i--) {
        if (result[i].sectProps == null) {
          result[i].sectProps = currentSectProps !== null && currentSectProps !== void 0 ? currentSectProps : defaultProps;
        } else {
...
`;
    ...
    renderStyles(styles) {
      ...
      for (const style of styles) {
        ...
        for (const subStyle of subStyles) {
          var _style$target;
          var selector = `${(_style$target = style.target) !== null && _style$target !== void 0 ? _style$target : ''}.${style.cssName}`;
    ...
    renderParagraph(elem) {
      var _elem$tabs, _style$paragraphProps2, _elem$numbering, _style$paragraphProps3;
      var result = this.toHTML(elem, ns.html, "p");
      const style = this.findStyle(elem.styleName);
      (_elem$tabs = elem.tabs) !== null && _elem$tabs !== void 0 ? _elem$tabs : elem.tabs = style === null || style === void 0 || (_style$paragraphProps2 = style.paragraphProps) === null || _style$paragraphProps2 === void 0 ? void 0 : _style$paragraphProps2.tabs;
      const numbering = (_elem$numbering = elem.numbering) !== null && _elem$numbering !== void 0 ? _elem$numbering : style === null || style === void 0 || (_style$paragraphProps3 = style.paragraphProps) === null || _style$paragraphProps3 === void 0 ? void 0 : _style$paragraphProps3.numbering;
      if (numbering) {
    ...
    renderHyperlink(elem) {
      ...
      if (elem.id) {
        ...
        res.href = (_rel$target = rel === null || rel === void 0 ? void 0 : rel.target) !== null && _rel$target !== void 0 ? _rel$target : res.href;
      }
      if (elem.anchor) {
    ...
    renderCommentRangeStart(commentStart) {
      ...
      const rng = new Range();
      (_this$commentHighligh = this.commentHighlight) === null || _this$commentHighligh === void 0 || _this$commentHighligh.add(rng);
      const result = this.h({
        tagName: "#comment",
    ...
    renderCommentReference(commentRef) {
      ...
      if (!this.options.renderComments) return null;
      var comment = (_this$document$commen = this.document.commentsPart) === null || _this$document$commen === void 0 ? void 0 : _this$document$commen.commentMap[commentRef.id];
      ...
      return this.h({
        ...
        }), commentRefEl, commentsContainerEl]
      });
    }
    renderAltChunk(elem) {
    ...
    renderImage(elem) {
      ...
      if (elem.srcRect && elem.srcRect.some(x => x != 0)) {
        var _elem$srcRect = _slicedToArray(elem.srcRect, 4),
          ...
          top = _elem$srcRect[1],
          right = _elem$srcRect[2],
          bottom = _elem$srcRect[3];
      ...
      if (elem.rotation) transform = `rotate(${elem.rotation}deg) ${transform !== null && transform !== void 0 ? transform : ''}`;
      result.style.transform = (_transform = transform) === null || _transform === void 0 ? void 0 : _transform.trim();
      if (this.document) {
    ...
    renderBreak(elem) {
      return elem.break == "textWrapping" ? this.h({
        tagName: "br"
      }) : null;
    }
    renderInserted(elem) {
    ...
    renderTab(elem) {
      ...
      if (this.options.experimental) {
        ...
        var stops = (_findParent = findParent(elem, DomType.Paragraph)) === null || _findParent === void 0 ? void 0 : _findParent.tabs;
    ...
    renderVmlElement(elem) {
      ...
      if ((_elem$imageHref = elem.imageHref) !== null && _elem$imageHref !== void 0 && _elem$imageHref.id) {
        var _this$document;
        this.tasks.push((_this$document = this.document) === null || _this$document === void 0 ? void 0 : _this$document.loadDocumentImage(elem.imageHref.id, this.currentPart).then(x => result.setAttribute("href", x)));
      }
    ...
    renderMmlRadical(elem) {
      ...
      if ((_elem$props = elem.props) !== null && _elem$props !== void 0 && _elem$props.hideDegree) {
    ...
    renderMmlDelimiter(elem) {
      var _elem$props$beginChar, _elem$props$endChar;
      const children = [];
      children.push(this.createMathMLElement("mo", null, [(_elem$props$beginChar = elem.props.beginChar) !== null && _elem$props$beginChar !== void 0 ? _elem$props$beginChar : '(']));
      children.push(...this.renderElements(elem.children));
      children.push(this.createMathMLElement("mo", null, [(_elem$props$endChar = elem.props.endChar) !== null && _elem$props$endChar !== void 0 ? _elem$props$endChar : ')']));
      return this.createMathMLElement("mrow", null, children);
    }
    renderMmlNary(elem) {
      var _elem$props$char, _elem$props2;
      const children = [];
      ...
      const charElem = this.createMathMLElement("mo", null, [(_elem$props$char = (_elem$props2 = elem.props) === null || _elem$props2 === void 0 ? void 0 : _elem$props2.char) !== null && _elem$props$char !== void 0 ? _elem$props$char : '\u222B']);
      if (supElem || subElem) {
    ...
    toH(elem, ns, tagName) {
      ...
      return {
        ...
        lang,
        style,
        children: children !== null && children !== void 0 ? children : this.renderElements(elem.children)
      };
    }
    toHTML(elem, ns, tagName) {
      let children = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    ...
    styleToString(selectors, values) {
      let cssText = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    ...
    levelTextToContent(text, suff, id, numformat) {
      ...
      return `"${result}${(_suffMap$suff = suffMap[suff]) !== null && _suffMap$suff !== void 0 ? _suffMap$suff : ""}"`;
    }
    numFormatToCssValue(format) {
      ...
      return (_mapping$format = mapping[format]) !== null && _mapping$format !== void 0 ? _mapping$format : format;
    }
    refreshTabStops() {
  ...
  async function renderAsync(data, bodyContainer, styleContainer, userOptions) {
    ...
    styleContainer !== null && styleContainer !== void 0 ? styleContainer : styleContainer = bodyContainer;
    styleContainer.innerHTML = "";
    bodyContainer.innerHTML = "";
    if ((_ops$fonts = ops.fonts) !== null && _ops$fonts !== void 0 && _ops$fonts.length) {
    ...
    if ((_ops$fonts2 = ops.fonts) !== null && _ops$fonts2 !== void 0 && _ops$fonts2.length && fontSet !== null && fontSet !== void 0 && fontSet.load) {
      try {
        await Promise.all(ops.fonts.map(f => {
          var _f$style, _f$weight;
          return fontSet.load(`${(_f$style = f.style) !== null && _f$style !== void 0 ? _f$style : 'normal'} ${(_f$weight = f.weight) !== null && _f$weight !== void 0 ? _f$weight : 'normal'} 12px "${f.name.replace(/["\\\r\n]/g, '')}"`);
        }));
      } catch {}
    }
    if (ops.paginate) {
      if (fontSet !== null && fontSet !== void 0 && fontSet.ready) {
        try {
          await fontSet.ready;
        } catch {}
      }
